                                ...
                                <div class="table-responsive mb-4">
                                    <table id="style-3" class="table style-3  table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 0;
                                            $selectProduct = mysqli_query($con, "SELECT * FROM `slider`  order by id desc");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $fetchProduct['sub_title'] ?></td>
                                                    <td class="text-center">
                                                        <span><img src="../uploads/slider/<?= $fetchProduct['image'] ?>" class="profile-img" alt="<?= $fetchProduct['title'] ?>"></span>
                                                    </td>
                                                    <td class="text-center">
                                                        <ul class="table-controls">
                                                            <li><a href="slider?edit=<?= $fetchProduct["id"] ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-6 mb-1">
