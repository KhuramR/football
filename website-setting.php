...
<head>
    ...
    <title>Website Setting - <?= $fetchWebsite['site_name'] ?></title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Website Setting</span></li>
                            </ol>
                        </nav>
                                    ...
                                    <form id="update">
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="inputEmail4" value="<?= $fetch['site_name'] ?>" name="name" placeholder="Website Name">
                                            </div>
                                        ...
                                        <div class="form-row mb-4">
                                          <div class="form-group col-md-4">
                                                ...
                                                <input type="email" placeholder="Email" class="form-control" name="email"  value="<?= $fetch['site_email'] ?>" id="inputPassword4" >
                                                  <input type="hidden" value="back" id="design">
                                         <input type="hidden"  id="page" value="setting">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputPassword4">Phone Number</label>
                                                <input type="text" placeholder="Phone" class="form-control" name="phone"  value="<?= $fetch['office_phone'] ?>" id="inputPassword4" >
                                            </div> 
                                            <div class="form-group col-md-4">
                                                <label for="inputPassword4">GST</label>
                                                <input type="text" placeholder="GST" class="form-control"  value="<?= $fetch['gst'] ?>" name="gst" id="inputPassword4" >
                                            </div>
                                        ...
                                        <div class="form-row mb-4">
                                          <div class="form-group col-md-6">
                                                ...
                                                <input type="text" placeholder="Facebook Url" class="form-control"  value="<?= $fetch['fb_link'] ?>" name="fb" id="inputPassword4" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Instagram Url</label>
                                                <input type="text" placeholder="Instagram Url" class="form-control"  value="<?= $fetch['insta_link'] ?>" name="insta" id="inputPassword4" >
                                            </div> 
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Twitter Url</label>
                                                <input type="text" placeholder="Twitter Url" class="form-control"  value="<?= $fetch['twitter_link'] ?>" name="twitter" id="inputPassword4" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Google Map Url</label>
                                                <input type="text" placeholder="Google Map Url" class="form-control"  value="<?= $fetch['map_link'] ?>" name="map" id="inputPassword4" >
                                            </div>
                                        ...
                                        <div class="form-row mb-4">
                                          <div class="form-group col-md-6">
                                                <label for="inputPassword4">Logo Image</label>
                                                <input type="file"  name="logo" class="form-control" id="inputPassword4" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Favicon Image</label>
                                                <input type="file" name="favicon" class="form-control" id="inputPassword4" >
                                            </div>
                                         ...
                                         <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress" name="address" value="<?= $fetch['office_address'] ?>" placeholder="Office Address">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="inputAddress">Short Description</label>
                                            <textarea type="text" class="form-control" id="inputAddress" name="desc" placeholder="Short Description">
