...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
     <title>Category - <?= $fetchWebsite['site_name'] ?></title>
                                    ...
                                    <?php } ?> 
                                        ...
                                        <div class="form-row mb-4">
                                          <div class="form-group col-md-12">
                                                ...
                                                <input type="text" placeholder="Category Name" class="form-control" value="<?= @$fetch['name'] ?>" name="name" id="inputPassword4" >
                                            </div>
                                        ...
                                        <div class="form-row mb-4">
                                              ...
                                              <div class="form-group col-md-6">
                                                <label for="inputPassword4">Main Category</label>
                                                ...
                                                while($fetchCategory = mysqli_fetch_array($selectCategory)){
                                                  if($fetchCategory['id']==$fetch['categoryid']){
                                                  ?>
                                 }
<option  value="<?= $fetchCategory['id'] ?>" selected><?= @$fetchCategory['name'] ?></option>
                                                <?php } ?>
                                                  <option  value="<?= @$fetchCategory['id'] ?>"><?= @$fetchCategory['name'] ?></option>
                                               <?php  } ?>
